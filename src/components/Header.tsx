    ...
    >
      ...
      <div className="hidden md:flex items-center space-x-4">
        <a
          ...
          target="_blank"
          className="flex items-center justify-center w-9 h-9 bg-transparent rounded-md transition-all duration-200 hover:scale-105 hover:shadow-lg"
        >
          <Image 
      ...
      <div className="md:hidden flex items-center space-x-4">
        <a
          href="https://x.com/solanaappkit"
          target="_blank"
          className="flex items-center justify-center w-8 h-8 bg-transparent hover:bg-white/10 rounded-md transition-all duration-200 hover:scale-105 hover:shadow-lg"
        >
          <Image 
            src="/icons/twitter-x.svg" 
            alt="Twitter/X" 
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 bg-[#0C101A] z-50 flex flex-col px-8 py-8">
          ...
          <div className="mt-auto flex flex-col space-y-4">
            ...
            <button onClick={() => window.open("https://github.com/sendarcade/solana-app-kit", "_blank")} className="bg-white text-black rounded-full py-3 font-medium flex justify-center items-center gap-2">
              Github
              <svg
            ...
            <button onClick={() => window.open("https://docs.solanaappkit.com/", "_blank")} className="bg-[#2D3138] text-white rounded-full py-3 font-medium">
              Documentation
            </button>
          </div>
        </div>
