            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-20 w-full max-w-6xl">
              ...
              <motion.div
                ...
                style={{
                  ...
                  transition:
                    "filter 0.6s ease-out, transform 0.2s ease-out, box-shadow 0.2s ease-out",
              ...
              <motion.div
                ...
                style={{
                  ...
                  filter: isInView ? "blur(0px)" : "blur(4px)",
                  transition:
                    "filter 1s ease-out, transform 0.2s ease-out, box-shadow 0.2s ease-out",
                  willChange: "transform, filter",
                }}
              >
                <div className="relative aspect-[9/16] w-full max-w-[260px] overflow-hidden rounded-[32px] border-8 border-[#292D36]">
